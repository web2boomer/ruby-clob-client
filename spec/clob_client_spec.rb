...
RSpec.describe ClobClient do
  it "has a version number" do
    expect(ClobClient::VERSION).not_to be nil
  end
  ...
  describe "Client" do
    ...
    let(:client) { ClobClient::Client.new(host: host, chain_id: chain_id, key: private_key) }

    describe "#create_order" do
      let(:order_args) do
        ClobClient::OrderArgs.new(
          token_id: "",
          price: 0.5,
          size: 100,
          side: "BUY",
    ...
    describe "#create_market_order" do
      let(:order_args) do
        ClobClient::MarketOrderArgs.new(
          ...
          nonce: 12345,
          taker: "0x0000000000000000000000000000000000000000",
          order_type: ClobClient::OrderType::FOK
        )
      end
