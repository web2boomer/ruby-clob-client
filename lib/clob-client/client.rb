...
module ClobClient
  class Client
    ...
    def get_api_keys
      ...
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::GET_API_KEYS)
    ...
    def get_closed_only_mode
      # TODO: Implement assert_level_2_auth
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::CLOSED_ONLY)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def delete_api_key
      # TODO: Implement assert_level_2_auth
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path: Endpoints::DELETE_API_KEY)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def get_orders(params = nil, next_cursor = 'MA==')
      ...
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::ORDERS)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def get_order(order_id)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: endpoint)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def get_trades(params = nil, next_cursor = 'MA==')
      # TODO: Implement assert_level_2_auth and cursor-based pagination
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::TRADES)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def create_order(order_args, options = nil)
      ...
      unless ClobClient::Utilities.price_valid(order_args.price, tick_size)
    ...
    def cancel(order_id)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path:  Endpoints::CANCEL, body: body)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def cancel_orders(order_ids)
      # TODO: Implement assert_level_2_auth
      body = order_ids
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path: Endpoints::CANCEL_ORDERS, body: body)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def cancel_all
      # TODO: Implement assert_level_2_auth
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path: Endpoints::CANCEL_ALL)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def cancel_market_orders(market: '', asset_id: '')
      ...
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path: Endpoints::CANCEL_MARKET_ORDERS, body: body)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def get_notifications
      # TODO: Implement assert_level_2_auth
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::GET_NOTIFICATIONS)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def drop_notifications(params = nil)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'DELETE', request_path: Endpoints::DROP_NOTIFICATIONS)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def get_balance_allowance(params = nil)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::GET_BALANCE_ALLOWANCE)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def update_balance_allowance(params = nil)
      # TODO: Implement assert_level_2_auth and add_balance_allowance_params_to_url
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::UPDATE_BALANCE_ALLOWANCE)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def is_order_scoring(params)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'GET', request_path: Endpoints::IS_ORDER_SCORING)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
    ...
    def are_orders_scoring(params)
      ...
      request_args = ClobClient::RequestArgs.new(method: 'POST', request_path: Endpoints::ARE_ORDERS_SCORING, body: body)
      headers = ClobClient::Headers.create_level_2_headers(@signer, @creds, request_args)
